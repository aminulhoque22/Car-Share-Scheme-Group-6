class Reservation < ApplicationRecord
  ...
  def orderTimeValidation
    ...
    elsif (expectedReturnTime - checkOutTime) < 1.hour || (expectedReturnTime - checkOutTime) > 30.hours
      errors.add(:expectedReturnTime, "should be within 1-30 hours of checkout time!")
    end
  end
